...
void run_editor() {
    ...
    if (ImGui::Button("Power")){
        nodes.push_back(new power_node(base_node_id++,base_pin_id++,base_pin_id++,base_pin_id++));
    }
    if (ImGui::Button("Sqrt")){
        nodes.push_back(new sqrt_node(base_node_id++,base_pin_id++,base_pin_id++));
    }
    if (ImGui::Button("Abs")){
        nodes.push_back(new abs_node(base_node_id++,base_pin_id++,base_pin_id++));
    }
    if (ImGui::Button("Print")){
        nodes.push_back(new print_node(base_node_id++,base_pin_id++,base_pin_id++,base_pin_id++));
    }
    if (ImGui::Button("For")){
        nodes.push_back(new for_node(base_node_id++,base_pin_id++,base_pin_id++,base_pin_id++,base_pin_id++,base_pin_id++,base_pin_id++));
    }
...
void copy_nodes() {
    ...
    for (int node = 0 ; node < nodes.size();node++) {
        if (ImNodes::IsNodeSelected(nodes[node]->id)) {
            copied_nodes.push_back(nodes[node]->type);
        }
    }
...
void paste_nodes() {
    ...
    for (int node = 0 ; node < copied_nodes.size();node++) {

        if (copied_nodes[node] == node_type::Start){
            nodes.push_back(new start_node(base_node_id++,base_pin_id++));
        }       
        if (copied_nodes[node] == node_type::Constant){
            nodes.push_back(new constant_node(base_node_id++,base_pin_id++));
        }
        if (copied_nodes[node] == node_type::Label){
            nodes.push_back(new label_node(base_node_id++,base_pin_id++));
        }
        if (copied_nodes[node] == node_type::Add){
            nodes.push_back(new add_node(base_node_id++,base_pin_id++,base_pin_id++,base_pin_id++));
        }
        if (copied_nodes[node] == node_type::Sub){
            nodes.push_back(new sub_node(base_node_id++,base_pin_id++,base_pin_id++,base_pin_id++));
        }
        if (copied_nodes[node] == node_type::Mul){
            nodes.push_back(new mul_node(base_node_id++,base_pin_id++,base_pin_id++,base_pin_id++));
        }
        if (copied_nodes[node] == node_type::Div){
            nodes.push_back(new div_node(base_node_id++,base_pin_id++,base_pin_id++,base_pin_id++));
        }
        if (copied_nodes[node] == node_type::Power){
            nodes.push_back(new power_node(base_node_id++,base_pin_id++,base_pin_id++,base_pin_id++));
        }
        if (copied_nodes[node] == node_type::Sqrt){
            nodes.push_back(new sqrt_node(base_node_id++,base_pin_id++,base_pin_id++));
        }
        if (copied_nodes[node] == node_type::Abs){
            nodes.push_back(new abs_node(base_node_id++,base_pin_id++,base_pin_id++));
        }
        if (copied_nodes[node] == node_type::Print){
            nodes.push_back(new print_node(base_node_id++,base_pin_id++,base_pin_id++,base_pin_id++));
        }
        if (copied_nodes[node] == node_type::For){
            nodes.push_back(new for_node(base_node_id++,base_pin_id++,base_pin_id++,base_pin_id++,base_pin_id++,base_pin_id++,base_pin_id++));
        }
